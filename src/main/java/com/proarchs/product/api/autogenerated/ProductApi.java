...
public interface ProductApi {
    ...
    ResponseEntity<String> productByProductIdPUT(@ApiParam(value = "",required=true) @PathVariable("productId") Integer productId,@ApiParam(value = "" ,required=true )  @Valid @RequestBody Product body);
